...
# Network parameters
tf.app.flags.DEFINE_integer('hidden_units', 16, 'Number of hidden units in each layer')
...
tf.app.flags.DEFINE_integer('eval_freq', 2000, 'Display training status every this iteration')
